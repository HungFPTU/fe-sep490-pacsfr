    ...
    QUEUE: {
        ...
        STAFF: {
            DASHBOARD: {
                ...
                GET_TICKET_DETAIL: (ticketNumber: string) => `/Queue/ticket/${ticketNumber}`,
                UPDATE_TICKET_STATUS: (ticketNumber: string, status: string) => `/Queue/ticket/${ticketNumber}/status?status=${status}`,
                CREATE_GUEST: "/Guests",
                GET_GUESTS: "/Guests",
                CREATE_CASE: "/Case",
                GET_SERVICES: "/Service",
                GET_SERVICE_SUBMISSION_METHODS: (serviceId: string) => `/Service/${serviceId}/submission-methods`,
