...
import { FileText, User, MapPin, Phone, Mail, Calendar, Tag, Info, MessageSquare, CheckCircle2, Clock, ArrowRight, FileDown } from 'lucide-react';
...
export const PaknDetailModal: React.FC<Props> = ({ open, onClose, id }) => {
  ...
  const canRespond = pakn && (pakn.status === 'DA_TIEP_NHAN' || pakn.status === 'DANG_XU_LY');
