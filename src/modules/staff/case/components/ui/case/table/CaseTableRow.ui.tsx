  ...
  return (
    ...
    >
      ...
      <td className="px-6 py-4">
        <div className="text-sm text-gray-900 font-medium">{caseItem.serviceName}</div>
      </td>

      {/* Priority */}
      <td className="px-6 py-4 whitespace-nowrap">
        <PriorityBadge priority={caseItem.priorityLevel} variant="dot" />
      </td>

      {/* Status */}
      <td className="px-6 py-4 whitespace-nowrap">
        <StatusBadge status={caseItem.currentStatus} showIcon />
      </td>

      {/* Payment */}
      <td className="px-2 py-4 whitespace-nowrap">
        <PaymentBadge isPaid={caseItem.isPayment} showIcon />
      </td>
