        ...
        <Sidebar className="bg-yellow-50/80 backdrop-blur-xl border-red-200/60">
            ...
            <SidebarContent>
                <div className="p-2 flex justify-center">
                    <button
                        onClick={onNewChat}
                        className="inline-flex items-center justify-center gap-2 px-3.5 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                    >
                        <PlusIcon />
