...
interface ServiceGroupCardProps {
    serviceGroup: ServiceGroupWithType;
...
export const ServiceGroupCard: React.FC<ServiceGroupCardProps> = ({
    ...
    const IconComponent = getServiceGroupIcon(serviceGroup.groupName, serviceType);
    const isCitizen = serviceType === ServiceType.CITIZEN;

    return (
        <Link
            href={`/nhom-dich-vu/${serviceGroup.id}`}
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                {serviceGroup.serviceCount !== undefined && (
                    <p className="mt-1 text-xs text-gray-500">
                        {serviceGroup.serviceCount} dịch vụ
                    </p>
                )}
            </div>
