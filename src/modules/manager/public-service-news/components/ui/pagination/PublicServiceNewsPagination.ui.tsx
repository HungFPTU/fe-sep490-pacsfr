...
export const PublicServiceNewsPagination: React.FC<Props> = ({
    page,
    pageSize,
    total,
    totalPages,
        ...
        <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3 sm:px-6">
            <div className="flex flex-1 items-center justify-between">
                <p className="text-sm text-slate-700">
                    Hiển thị <span className="font-medium">{total === 0 ? 0 : startItem}</span> đến{" "}
                    <span className="font-medium">{total === 0 ? 0 : endItem}</span> trong tổng số{" "}
