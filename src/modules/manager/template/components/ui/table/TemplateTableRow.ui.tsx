    ...
    return (
        <tr key={template.id} className="hover:bg-slate-50">
            ...
            <td className="px-6 py-4 text-sm text-slate-500">
                {template.fileName ? (
                    <div className="flex flex-col">
                        ...
                        {template.fileSize && (
                            <span className="text-xs text-slate-400">{formatFileSize(template.fileSize)}</span>
                        )}
                    </div>
                ) : (
                    '-'
            ...
            <td className="whitespace-nowrap px-6 py-4 text-sm">
                <span
                    className={`inline-flex rounded-full px-2 py-1 text-xs font-semibold ${template.isActive
