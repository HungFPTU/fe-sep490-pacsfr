...
export const NewsCategoryForm: React.FC<Props> = ({ form, isLoading, isEdit }) => {
    return (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            {/* Category Code */}
            <form.Field name="categoryCode">
                {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                {(field: any) => {
                    return (
            ...
            <div className="md:col-span-2">
                <form.Field
                    ...
                    validators={{
                        onBlur: ({ value }: { value: string | undefined }) => validateCategoryDescription(value),
                    }}
                >
                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                    {(field: any) => {
                        ...
                        return (
                            <div className="w-full">
                                <label htmlFor="categoryDescription" className="mb-1 inline-block text-sm font-medium text-slate-700">
                                    Mô tả
                                </label>
                                <textarea
