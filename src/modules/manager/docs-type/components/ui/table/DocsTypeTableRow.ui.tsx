...
export const DocsTypeTableRow: React.FC<Props> = ({
    ...
    return (
        <tr key={docsType.id} className="hover:bg-slate-50">
            {/* Code */}
            ...
            {/* Name */}
            <td className="px-6 py-4 text-sm text-slate-900">{docsType.docTypeName}</td>
            ...
            <td className="whitespace-nowrap px-6 py-4 text-sm">
                <span
                    className={`inline-flex rounded-full px-2 py-1 text-xs font-semibold ${docsType.isActive
            ...
            <td className="whitespace-nowrap px-6 py-4 text-sm text-slate-500">
                {docsType.modifiedAt ? (
                    <div className="flex flex-col">
                        <span>{formatDate(docsType.modifiedAt)}</span>
                    </div>
                ) : docsType.createdAt ? (
                    <div className="flex flex-col">
                        <span>{formatDate(docsType.createdAt)}</span>
                    </div>
                ) : (
                    '-'
                )}
