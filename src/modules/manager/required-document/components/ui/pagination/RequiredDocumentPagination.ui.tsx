...
export const RequiredDocumentPagination: React.FC<Props> = ({
    page,
    pageSize,
    total,
    totalPages,
        ...
        <div className="mt-4 flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3 sm:px-6">
            <div className="flex flex-1 items-center justify-between">
                <p className="text-sm text-slate-700">
                    ...
                    <span className="font-medium">{total}</span> tài liệu yêu cầu
                </p>
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        <label className="text-sm text-slate-700" htmlFor="required-document-page-size">
                            Số dòng
                        </label>
                        <select
                            id="required-document-page-size"
                            value={pageSize}
