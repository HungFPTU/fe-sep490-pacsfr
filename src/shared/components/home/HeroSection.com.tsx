...
export function HeroSection() {
    return (
        <section className="relative min-h-screen flex items-center bg-gradient-to-br from-red-50 via-white to-rose-50 overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-40 right-10 w-96 h-96 bg-rose-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse animation-delay-2000"></div>
                <div className="absolute bottom-20 left-20 w-80 h-80 bg-red-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse animation-delay-4000"></div>
            </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed mb-10 max-w-2xl">
                            ...
                            <span className="text-red-600 font-semibold"> nâng cao chất lượng phục vụ</span> người dân.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <Link href="/login">
                                <Button className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-semibold px-8 py-4 text-lg rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="relative">
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                                ...
                                <div className="space-y-4">
                                    <div className="h-4 bg-gradient-to-r from-red-300 to-red-400 rounded w-3/4"></div>
                                    <div className="h-4 bg-gradient-to-r from-green-300 to-green-400 rounded w-1/2"></div>
                                    <div className="h-4 bg-gradient-to-r from-rose-300 to-rose-400 rounded w-2/3"></div>

                                    <div className="grid grid-cols-2 gap-4 mt-6">
                                        <div className="h-16 bg-gradient-to-br from-red-100 to-red-200 rounded-lg"></div>
